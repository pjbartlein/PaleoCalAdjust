...
# output .pngs path
png_path <- paste(path_prefix, "Projects/Calendar/data/Ellipse/orb_position/", sep="")
...
for (i in (1:nt)) {
  ...
  png_file <- paste(png_path, "orb_position_", png_name, "_ka.png", sep="")
...
# magick -delay 50 @orb_position_files.txt -loop 0 -layers Optimize orb_position.gif
