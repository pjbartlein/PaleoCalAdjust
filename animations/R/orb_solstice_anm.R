...
# output .pngs path
png_path <- paste(path_prefix, "Projects/Calendar/data/Ellipse/orb_solstice_anm/", sep="")
...
for (i in (1:nt)) {
  ...
  # magick -delay 50 @orb_solstice_anm_files.txt -loop 0 -layers Optimize orb_solstice_anm.gif
