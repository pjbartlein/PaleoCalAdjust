...
!
! Version: 1.0e  (Generalize to 4-d files)
...
real(4), allocatable    :: var3d_in(:,:,:)      ! 3-D (e.g. nlon,nlat,nd or ndtot) input data 
...
do
    ...
    call define_outvar(ncid_in, ncid_out, varinname, varid_out, varoutname, addvarattname, addvaratt, & 
        varid_in) !, invar_dimlen(1), invar_dimlen(2), nt)
